          ...
          builder: (context,value,child) {
                    ...
                    builder: (context,value,child) {
                      return ListView(
                        children: [
                          ...
                          Image.asset("assets/img_2.png", height: 3, fit: BoxFit.fill),
                          SizedBox(height: 25),
                          Expanded(
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                bool isSelectedIndex = value.selectedIndex == index;
                                return InkWell(
                                  child: Container(
                                    height: 40,
            ...
            value.currentPage=0;
                          ...
                          InkWell(
                                ...
                                Column(
                                  ...
                                  children: [
                                    Text(
                                      ...
                                      style: TextStyle(
                                        color:
                                        value.selectedIndex == value.dashboardPages.length - 1
                                            ? Color(0xffF0E100)
                                            : Colors.white,
                                        fontSize: 10,
                                      ),
                            ...
                            onTap: () {
                              value.dashboardIndexItem(value.dashboardPages.length-1);
                ...
                Consumer<MainProvider>(
                  builder: (context,value,child) {
                    return Expanded(
                      child: SizedBox(child: value.dashboardPages[value.selectedIndex]),
                      flex: 5,
                    );
                  }
                ),
