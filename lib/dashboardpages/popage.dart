                            ...
                            builder: (context, value, child) {
                              return DataTable(
                                ...
                                columns: [
                                  ...
                                  DataColumn(
                                    label: tableHeading(text: "PO Status".tr()),
                                  ),
                                  DataColumn(
                                    label: tableHeading(text: "Cost".tr()),
                                  ),
                                  DataColumn(
                                    label: tableHeading(text: "Exporter".tr()),
                                  ),
                                ],
                                rows: List.generate(
                                  value
